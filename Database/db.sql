...
INSERT INTO tiles (name, description, price, rent_percentage, bank_sale, type, owner) VALUES
("Départ", "Recevez €200 chaque fois que vous passez ici.", 0, 0, 0, "go", 1000),
("Amphithéâtre", NULL, 100, 10, 50, "street", 1000),
("Caisse de Communauté", NULL, 0, 0, 0, "community", 1000),
("Foyer", NULL, 150, 10, 50, "street", 1000),
("Payer son café", "NULL", 200, 0, 0, "tax", 1000),
("OpenBox", NULL, 500, 15, 50, "utility", 1000),
("Salle A003", NULL, 150, 10, 50, "street", 1000),
("Chance", NULL, 0, 0, 0, "chance", 1000),
("Salle A004", NULL, 150, 10, 50, "street", 1000),
("Salle A005", NULL, 150, 10, 50, "street", 1000),
("En Prison", "Simple Visite", 0, 0, 0, "in_jail", 1000),
("Salle C002", NULL, 200, 10, 50, "street", 1000),
("Frais Cantine", NULL, 200, 0, 0, "tax", 1000),
("Salle C003", NULL, 200, 10, 50, "street", 1000),
("Salle C004", NULL, 200, 10, 50, "street", 1000),
("F9 HETIC", NULL, 500, 15, 50, "utility", 1000),
("Bureau de Gardien", NULL, 250, 15, 50, "street", 1000),
("Caisse de Communauté", NULL, 0, 0, 0, "community", 1000),
("Bureau de Coordination", NULL, 250, 15, 50, "street", 1000),
("Bureau de Communication", NULL, 300, 15, 50, "street", 1000),
("Parc Gratuit", NULL, 0, 0, 0, "free", 1000),
("Salle C012", NULL, 300, 15, 50, "street", 1000),
("Chance", NULL, 0, 0, 0, "chance", 1000),
("Salle C013", NULL, 300, 15, 50, "street", 1000),
("Salle C014", NULL, 350, 15, 50, "street", 1000),
("Synerg'hetic", NULL, 500, 20, 50, "utility", 1000),
("Salle A111", NULL, 350, 15, 50, "street", 1000),
("Salle A112", NULL, 350, 15, 50, "street", 1000),
("Assiduité", "Justifier ses abscences", 250, 0, 0, "tax", 1000),
("Salle A113", NULL, 400, 15, 50, "street", 1000),
("Allez en Prison", NULL, 0, 0, 0, "go_jail", 1000),
("Bureau d'Admission", NULL, 400, 20, 50, "street", 1000),
("Bureau Pédagogique", NULL, 400, 20, 50, "street", 1000),
("Caisse de Communauté", NULL, 0, 0, 0, "community", 1000),
("Bureau d'Administration", NULL, 450, 20, 50, "street", 1000),
("Nebula BDE", NULL, 500, 25, 50, "utility", 1000),
("Chance", NULL, 0, 0, 0, "chance", 1000),
("Salle A105", NULL, 450, 20, 50, "street", 1000),
("Comptabilité", "Payer les frais de scolarité", 200, 0, 0, "tax", 1000),
("Salle B101", NULL, 500, 20, 50, "street", 1000),
