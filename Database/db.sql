...
CREATE DATABASE 'monopoly' IF NOT EXISTS CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS cards (
	...
	target ("current_player", "other_players", "everyone"),						-- Holds the card's affected target
) ENGINE=INNODB;